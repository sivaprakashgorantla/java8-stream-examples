...
public class PalendromeDemo {
	...
	public static void main(String[] args) {
		...
		String str2 = "liril";
		boolean falg = IntStream.range(1, str2.length() /2 ).allMatch(c -> str2.charAt(c) == str2.charAt(str2.length() - c -1));
		
		System.out.println(str2 +"is palendrome : "+((falg == true ? "True" : " False")));
